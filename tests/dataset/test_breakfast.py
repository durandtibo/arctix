...
def test_breakfast_dataset_coarse(tmp_path: Path) -> None:
    tmp_path = Path(os.environ["ARCTIX_DATA_PATH"]).joinpath("breakfast")
    data_raw = fetch_data(tmp_path, "segmentation_coarse")
