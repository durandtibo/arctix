...
from arctix.reducers import EmptySequenceError, NumpyReducer, ReducerRegistry
...
def test_numpy_reducer_no_numpy() -> None:
    with patch("arctix.utils.imports.is_numpy_available", lambda *args, **kwargs: False):
