    ...
    return pl.DataFrame(
        {
            ...
            Column.START_TIME_SECOND_DIFF: [0.0, 4.23, 2.61],
            Column.START_TIMESTAMP: [
                datetime.time(0, 0, 0, 140000),
                datetime.time(0, 0, 4, 370000),
                datetime.time(0, 0, 6, 980000),
        ...
        schema={
            ...
            Column.START_TIME_SECOND_DIFF: pl.Float64,
            Column.START_TIMESTAMP: pl.Time,
            Column.STOP_FRAME: pl.Int64,
        ...
        pl.DataFrame(
            {
                ...
                Column.START_TIME_SECOND_DIFF: [
                    [0.0, 4.23, 2.61, 5.79, 2.48],
                    [0.0, 3.54, 1.52, 8.25],
                    [0.0, 2.98, 1.63, 1.69, 5.04],
                    [0.0, 2.76, 3.28],
                    [0.0, 2.37, 1.52, 0.71, 5.41],
                ],
                Column.START_TIMESTAMP: [
                    [
                        datetime.time(0, 0, 0, 140000),
            ...
            schema={
                ...
                Column.START_TIME_SECOND_DIFF: pl.List(pl.Float64),
        ...
        to_array(data_prepared2),
        {
            ...
            Column.START_TIME_SECOND: np.ma.masked_array(
                data=np.array(
                    [
                        [0.14, 4.37, 6.98, 12.77, 15.25],
                        [5.07, 8.61, 10.13, 18.38, -1.0],
                        [0.27, 3.25, 4.88, 6.57, 11.61],
                        [0.11, 2.87, 6.15, -1.0, -1.0],
                        [4.14, 6.51, 8.03, 8.74, 14.15],
                    ],
                    dtype=np.float64,
                ),
            ...
            Column.START_TIME_SECOND_DIFF: np.ma.masked_array(
                data=np.array(
                    [
                        [0.0, 4.23, 2.61, 5.79, 2.48],
                        [0.0, 3.54, 1.52, 8.25, -1.0],
                        [0.0, 2.98, 1.63, 1.69, 5.04],
                        [0.0, 2.76, 3.28, -1.0, -1.0],
                        [0.0, 2.37, 1.52, 0.71, 5.41],
                    ],
                    dtype=np.float64,
                ),
